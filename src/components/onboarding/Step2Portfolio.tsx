    ...
    <div>
        ...
        {formatOptions.map((fmt) => (
          <button
            ...
            className={`px-3 py-1 rounded border ${
              formats.includes(fmt) ? "bg-blue-500 text-white" : ""
            }`}
          >
            {typeof fmt === "string"
      ...
      <div className="mt-4">
        <p className="text-sm text-gray-700">
          Add at least one item. Media upload OR valid link required. You can
          mark items as featured later in the dashboard.
        </p>
      </div>
    </div>
  );
